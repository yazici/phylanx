...
namespace phylanx { namespace execution_tree { namespace primitives
{
    ...
    /// \param threshold Threshold for thresholded activations, scalar

    class relu
      : public primitive_component_base
      , public std::enable_shared_from_this<relu>
    {
    protected:
    ...
    public:
        ...
        relu(primitive_arguments_type&& operands, std::string const& name,
    ...
    inline primitive create_relu(hpx::id_type const& locality,
